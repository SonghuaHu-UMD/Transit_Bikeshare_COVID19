...
Station_poly.loc[Station_poly['2019_size_label'] == 5, '2019_size'] = 150
...
gplt.pointplot(Station_poly, scale='2019_size', limits=(2, 15), hue='Label_2019', cmap='Blues', legend=True,
               legend_var='scale', linewidth=0.1, edgecolor='k',
               extent=np.array([-87.80, 41.68454312, -87.5241371, 42.12303859]),
               legend_kwargs={'bbox_to_anchor': (0.65, 1), 'frameon': False},
               legend_values=[5, 20, 50, 90, 120, 150], legend_labels=['<5', '5-15', '15-30', '30-60', '60-90', '>90'],
               ax=ax1)
